...
---
Son Zamanlardaki Projelerim:
####  NLP Tabanlı Akıllı Konum Öneri Sistemi (Bitirme Projesi)
* Kullanıcıların serbest metin girişlerinden niyet analizi (yemek, market vb.) yaparak en uygun lokasyonları öneren bir platform geliştirdim.
* "Yakın" ve "acil" gibi kelimeleri doğal dil işleme ile algılayarak, sonuçları mesafeye göre dinamik olarak sıralayan bir algoritma entegre ettim.
...
* Veri ön işleme ve modelleme adımlarını uyguladım.
